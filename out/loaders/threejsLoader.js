define(["require", "exports", "../global/EditorData", "../assets/EditorRS"], function (require, exports, EditorData_1, EditorRS_1) {
    "use strict";
    ...
    var ThreejsLoader = /** @class */ (function () {
        ...
        ThreejsLoader.prototype.load = function (url, completed) {
            EditorRS_1.editorRS.fs.readArrayBuffer(url, function (err, data) {
    ...
    exports.ThreejsLoader = ThreejsLoader;
    exports.threejsLoader = new ThreejsLoader();
    ...
    var prepare = (function () {
        ...
        return function (callback) {
            ...
            feng3d.loadjs.load({
                ...
                ].map(function (value) { return EditorData_1.editorData.getEditorAssetPath(value); }),
                bundleId: "threejs",
                success: function () {
...
//# sourceMappingURL=threejsLoader.js.map