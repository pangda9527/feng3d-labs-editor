...
define(["require", "exports", "../recastnavigation/Recastnavigation"], function (require, exports, Recastnavigation_1) {
    "use strict";
    ...
    var Navigation = /** @class */ (function (_super) {
        ...
        Navigation.prototype.bake = function () {
            ...
            this._recastnavigation = this._recastnavigation || new Recastnavigation_1.Recastnavigation();
            this._recastnavigation.doRecastnavigation(geometry, this.agent);
            var voxels = this._recastnavigation.getVoxels();
            var voxels0 = voxels.filter(function (v) { return v.flag == Recastnavigation_1.VoxelFlag.Default; });
            var voxels1 = voxels.filter(function (v) { return v.flag != Recastnavigation_1.VoxelFlag.Default; });
            var voxels2 = voxels.filter(function (v) { return !!(v.flag & Recastnavigation_1.VoxelFlag.IsContour); });
