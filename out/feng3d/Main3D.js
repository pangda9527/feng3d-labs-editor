...
define(["require", "exports", "./EditorComponent", "./hierarchy/Hierarchy", "../global/EditorData", "./scene/SceneRotateTool", "./GroundGrid", "./mrsTool/MRSTool", "../ui/assets/EditorAsset", "../assets/EditorRS", "../shortcut/Editorshortcut"], function (require, exports, EditorComponent_1, Hierarchy_1, EditorData_1, SceneRotateTool_1, GroundGrid_1, MRSTool_1, EditorAsset_1, EditorRS_1, Editorshortcut_1) {
    "use strict";
    ...
    var EditorEngine = /** @class */ (function (_super) {
        ...
        EditorEngine.prototype.render = function () {
            ...
            EditorData_1.editorData.selectedGameObjects.forEach(function (element) {
    ...
    */
    var Main3D = /** @class */ (function () {
        ...
        Main3D.prototype.init = function () {
            ...
            //
            exports.editorScene.gameObject.addComponent(SceneRotateTool_1.SceneRotateTool);
            //
            //初始化模块
            exports.editorScene.gameObject.addComponent(GroundGrid_1.GroundGrid);
            exports.editorScene.gameObject.addComponent(MRSTool_1.MRSTool);
            exports.editorComponent = exports.editorScene.gameObject.addComponent(EditorComponent_1.EditorComponent);
            feng3d.loader.loadText(EditorData_1.editorData.getEditorAssetPath("gameobjects/Trident.gameobject.json"), function (content) {
            ...
            window.addEventListener("beforeunload", function () {
                EditorRS_1.editorRS.fs.writeObject("default.scene.json", exports.engine.scene.gameObject);
            });
        };
        Main3D.prototype.onEditorCameraRotate = function (e) {
            ...
            var lookDistance;
            if (EditorData_1.editorData.selectedGameObjects.length > 0) {
                //计算观察距离
                var selectedObj = EditorData_1.editorData.selectedGameObjects[0];
                ...
                lookDistance = Editorshortcut_1.sceneControlConfig.lookDistance;
            }
            //旋转中心
