...
var MTool_1 = require("./MTool");
var RTool_1 = require("./RTool");
var STool_1 = require("./STool");
...
var MRSTool = /** @class */ (function (_super) {
    ...
    MRSTool.prototype.onSelectedGameObjectChange = function () {
        var objects = editorData.selectedGameObjects.filter(function (v) { return !(v.hideFlags & feng3d.HideFlags.DontTransform); });
        //筛选出 工具控制的对象
        if (objects.length > 0) {
