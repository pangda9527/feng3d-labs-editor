...
define(["require", "exports", "../Main3D", "./MRSToolBase", "./models/RToolModel", "./MRSToolTarget"], function (require, exports, Main3D_1, MRSToolBase_1, RToolModel_1, MRSToolTarget_1) {
    "use strict";
    ...
    var RTool = /** @class */ (function (_super) {
        ...
        RTool.prototype.init = function (gameObject) {
            ...
            this.toolModel = new feng3d.GameObject().addComponent(RToolModel_1.RToolModel);
        };
        ...
        RTool.prototype.onItemMouseDown = function (event) {
            ...
            MRSToolTarget_1.mrsToolTarget.startRotate();
            //
        ...
        RTool.prototype.onMouseMove = function () {
            switch (this.selectedItem) {
                ...
                case this.toolModel.cameraAxis:
                    ...
                    angle = angle * sign;
                    //
                    MRSToolTarget_1.mrsToolTarget.rotate1(angle, this.movePlane3D.getNormal());
                    this.stepPlaneCross.copy(planeCross);
                    MRSToolTarget_1.mrsToolTarget.startRotate();
                    //绘制扇形区域
                    if (this.selectedItem instanceof RToolModel_1.CoordinateRotationAxis) {
                        this.selectedItem.showSector(this.startPlanePos, planeCross);
                    }
                    break;
                case this.toolModel.freeAxis:
                    var endPoint = Main3D_1.engine.mousePos.clone();
                    var offset = endPoint.subTo(this.startMousePos);
                    var cameraSceneTransform = Main3D_1.editorCamera.transform.localToWorldMatrix;
                    var right = cameraSceneTransform.right;
                    var up = cameraSceneTransform.up;
                    MRSToolTarget_1.mrsToolTarget.rotate2(-offset.y, right, -offset.x, up);
                    //
        ...
        RTool.prototype.onMouseUp = function () {
            ...
            MRSToolTarget_1.mrsToolTarget.stopRote();
            this.startMousePos = null;
            this.startPlanePos = null;
            this.startSceneTransform = null;
        };
        RTool.prototype.updateToolModel = function () {
            var cameraSceneTransform = Main3D_1.editorCamera.transform.localToWorldMatrix.clone();
            var cameraDir = cameraSceneTransform.forward;
            cameraDir.negate();
            //
