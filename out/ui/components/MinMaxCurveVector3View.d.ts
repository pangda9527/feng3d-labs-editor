...
export declare class MinMaxCurveVector3View extends eui.Component {
    minMaxCurveVector3: feng3d.MinMaxCurveVector3;
    xMinMaxCurveView: MinMaxCurveView;
    yMinMaxCurveView: MinMaxCurveView;
    zMinMaxCurveView: MinMaxCurveView;
    constructor();
