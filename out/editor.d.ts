...
declare namespace editor {
     ...
     * 本地文件系统
     */
    class NativeFS implements feng3d.IReadWriteFS {
        /**
         * 项目路径
         */
        projectname: string;
...
declare namespace editor {
    ...
    class EditorRS extends feng3d.ReadWriteRS {
         ...
         * @param callback 完成回调
         */
        exportProjectToJSZip(filename: string, callback?: () => void): void;
        /**
         * 导出指定文件夹为zip压缩包
         *
         * @param filename 导出后压缩包名称
         ...
         * @param callback 完成回调
         */
        exportFolderToJSZip(filename: string, folderpath: string, callback: () => void): void;
        /**
         * 导出文件列表为zip压缩包
         *
         * @param filename 导出后压缩包名称
         ...
         * @param callback 完成回调
         */
        exportFilesToJSZip(filename: string, filepaths: string[], callback?: () => void): void;
        /**
         * 导入项目
         */
...
```
         *
         */
        popup(menuItems: MenuItem[]): MenuUI;
        /**
    ...
    class MenuUI extends eui.List {
        get subMenuUI(): MenuUI;
        set subMenuUI(v: MenuUI);
        private _subMenuUI;
        private parentMenuUI;
        get topMenu(): MenuUI;
        constructor();
        static create(menuItems: MenuItem[], menuItemRendererRect?: egret.Rectangle): MenuUI;
        private onComplete;
        private onAddedToStage;
        private onRemovedFromStage;
        private updateView;
...
declare namespace editor {
    class OVTransform extends eui.Component implements feng3d.IObjectView {
        ...
        private onAddedToStage;
        private onRemovedFromStage;
        get space(): feng3d.Transform;
        set space(value: feng3d.Transform);
        getAttributeView(attributeName: String): any;
        getblockView(blockName: String): any;
        /**
         * 更新界面
...
declare namespace editor {
    class OAVComponentList extends OAVBase {
        ...
        set space(value: feng3d.GameObject);
        get attributeName(): string;
...
declare namespace editor {
    ...
    class InspectorView extends eui.Component implements ModuleView {
         ...
         * 最多存储历史选中对象数量
         */
        private _maxHistorySelectedObject;
        get historySelectedObjectLength(): number;
        /**
         *
         */
        preSelectedObjects(): void;
        private showData;
...
declare namespace editor {
     ...
     * 动画面板
     */
    class AnimationView extends eui.Component implements ModuleView {
        static moduleName: string;
        moduleName: string;
        constructor();
        private onComplete;
...
declare namespace editor {
    ...
    class EditorData {
         ...
         * @param objs 选中的对象
         */
        selectMultiObject(objs: (feng3d.GameObject | AssetNode)[], isAdd?: boolean): void;
        /**
         * 使用的控制工具类型
         */
         ...
         * 选中游戏对象列表
         */
        get selectedGameObjects(): feng3d.GameObject[];
...
declare namespace editor {
    class MRSToolTarget {
        ...
        private _position;
        private _rotation;
        get controllerTool(): feng3d.Transform;
        set controllerTool(value: feng3d.Transform);
...
declare namespace editor {
    class MRSToolBase extends feng3d.Component {
        ...
        protected get toolModel(): feng3d.Component;
        protected set toolModel(value: feng3d.Component);
        get selectedItem(): CoordinateAxis | CoordinatePlane | CoordinateRotationFreeAxis | CoordinateRotationAxis | CoordinateCube | CoordinateScaleCube;
        set selectedItem(value: CoordinateAxis | CoordinatePlane | CoordinateRotationFreeAxis | CoordinateRotationAxis | CoordinateCube | CoordinateScaleCube);
...
declare namespace editor {
    ...
    class Feng3dScreenShot {
         ...
         * @param texture 贴图
         */
        drawTexture(texture: feng3d.Texture2D): string;
        /**
         * 绘制立方体贴图
        ...
        updateCameraPosition(gameObject: feng3d.GameObject): void;
